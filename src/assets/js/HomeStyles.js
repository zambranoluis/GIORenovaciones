const styles = {
	main: "flex flex-col w-full h-full justify-center items-center bg-white",
	section: "min-h-[80vh] w-full relative",
	video: "w-full h-full absolute object-cover top-0 left-0 z-[1]",
	images:
		"w-full h-full flex justify-center items-center top-0 left-0 absolute z-[1]",
	section2:
	...
	divition: "flex items-center justify-center w-full py-2 bg-[#0a4334]",
	gridIcons:
	...
	map: "flex items-center justify-center",
	textLegend: "flex flex-col font-poppins gap-8",
	list: "flex flex-col items-start font-poppins justify-start text-lg ",
};
